...
def check_in_done_list(driver, item_name, shouldBeInList = True):
    all_done_items, all_done_names = get_items_in_list(driver, 'all-done-items')
    recent_done_items, recent_done_names = get_items_in_list(driver, 'recent-done-items')
    older_done_items, older_done_names = get_items_in_list(driver, 'older-done-items')
